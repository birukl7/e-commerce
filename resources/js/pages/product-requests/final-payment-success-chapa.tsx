...
interface FinalPaymentSuccessChapaProps {
...
export default function FinalPaymentSuccessChapa({ 
  productRequest, 
  message = 'Your final payment was successful! Your order is now complete.',
  transaction_id,
  amount
}: FinalPaymentSuccessChapaProps) {
  ...
  return (
    <MainLayout title="Final Payment Successful">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <Card className="border-green-200">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-2xl text-green-700">Final Payment Successful!</CardTitle>
            <CardDescription className="text-base mt-2">{message}</CardDescription>
          </CardHeader>
          
          <CardContent className="space-y-6">
            {productRequest.final_payment_status === 'processing' && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Final Amount Paid:</span>
                  <span className="font-semibold text-green-700">
                    {formatCurrency(amount || productRequest.final_amount, productRequest.currency)}
                  </span>
                </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Order Complete!</strong> Your final payment has been processed. 
                Your order will be prepared for shipment once the payment is approved by admin.
              </p>
            </div>
