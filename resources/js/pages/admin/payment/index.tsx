...
import { ArrowUpDown, CreditCard, DollarSign, Download, Eye, Filter, Search, TrendingDown, TrendingUp, X } from 'lucide-react';
...
export default function AdminPaymentIndex({ payments, stats, filters }: AdminPaymentIndexProps) {
    ...
    const successRate = stats.total_transactions > 0 ? ((stats.successful_payments / stats.total_transactions) * 100).toFixed(1) : '0';
        ...
        <AppLayout breadcrumbs={breadcrumbs} mainNavItems={adminNavItems} footerNavItems={[]}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6 font-sans">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-foreground">Payment Statistics</h1>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-border/50 shadow-sm transition-shadow hover:shadow-md">
                        ...
                        <CardContent>
                            ...
                            <div className="flex items-center gap-1 text-xs">
                                ...
                                <span className="text-muted-foreground">Today: {formatCurrency(stats.today_revenue)}</span>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-border/50 shadow-sm transition-shadow hover:shadow-md">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-red-600">{stats.failed_payments + stats.pending_payments}</div>
                            <div className="flex items-center gap-1 text-xs">
                                <span className="text-muted-foreground">
                                    Failed: {stats.failed_payments} | Pending: {stats.pending_payments}
                                </span>
                            </div>
                        </CardContent>
                    </Card>
                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    {payments.data.map((payment) => (
                                        <tr key={payment.id} className="border-b border-border/30 hover:bg-muted/30">
                                            <td className="py-4">
