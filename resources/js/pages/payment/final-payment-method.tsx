...
interface FinalPaymentMethodProps {
  order_id: string
  amount: number
  currency: string
  product_name: string
...
export default function FinalPaymentMethod({
  order_id,
  amount,
  currency,
  product_name,
  ...
  return (
    <MainLayout title="Final Payment Method">
      <Head title="Final Payment Method" />
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">Final Payment Method</CardTitle>
            <p className="text-gray-600">Choose how you'd like to pay the final amount</p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <h4 className="font-semibold text-green-800 mb-2">About Final Payment</h4>
              <ul className="text-sm text-green-700 space-y-1">
                <li>• This is the remaining 70% payment for your order</li>
                <li>• Your product has arrived and is ready for delivery</li>
                <li>• Once payment is confirmed, we will proceed with delivery arrangements</li>
